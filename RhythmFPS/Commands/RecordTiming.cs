...
public class RecordTiming : ICommand
{
    public bool Execute(ArraySegment<string> arguments, ICommandSender sender, [UnscopedRef] out string response)
    {
        ...
        song.RecordTiming(player);

        response = "녹음을 시작합니다.";
        return true;
    }

    public string Command { get; } = "recordtiming";
    public string[] Aliases { get; } = { "rt" };
    public string Description { get; } = "박자를 녹음합니다.";
}